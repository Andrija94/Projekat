...
def flights_output(flights):  #funkicja koristi listu letova koja je dobijena iz pretrage i formatira je za ispis korisniku
    if len(flights) == 0:
        print("Nema letova")
    else:
        print("{:6} | {} | {} | {} | {:15} | {:25} | {:25} | {} | {}".format("ID", "Polazak", "Dolazak", "Vreme polaska",
                                                                             "Vreme dolaska",
...
def search(flights):    #funkcija koristi listu svih letova i po odredjenom kriterijumu pretrazuje letove i ispisuje rezultate
    ...
    try:
        ...
        flights_output(list)    #poziv funkcije koja ispisuje rezultate pretrage
    except:
        print("Pogresan unos")
